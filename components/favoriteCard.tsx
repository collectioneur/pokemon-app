...
export function FavoriteCard({pokemon, handleRemove, handlePressDetails}: Props) {
  if (!pokemon) {
    return (
  ...
  return (
      ...
      />
        ...
        <Pressable onPress={() => handlePressDetails(pokemon)} className="flex-row grow justify-center items-center bg-[##5b21b6] rounded-full gap-2 px-4 py-2"
